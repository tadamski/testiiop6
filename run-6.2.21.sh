...
jacorb="${jbossHome}/modules/system/layers/base/org/jacorb/main/jacorb-2.3.2.redhat-6.jar:${jbossHome}/layers/base/org/jboss/as/jacorb/main/jboss-as-jacorb-7.5.21.Final-redhat-1.jar"
wfly_jacorb=${jbossHome}/modules/system/layers/base/org/jboss/as/jacorb/main/jboss-as-jacorb-7.5.21.Final-redhat-1.jar
...
java $JAVA_OPTS -agentlib:jdwp=transport=dt_socket,address=12346,server=y,suspend=n -cp $cp org.jboss.test.iiop.client.JDKClient $*
