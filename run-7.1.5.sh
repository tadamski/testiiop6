...
#orb=${modules}/javax/orb/api/main/openjdk-orb-8.0.8.Final-redhat-1.jar:${modules}/org/jboss/as/jacorb/main/wildfly-jacorb-7.1.5.GA-redhat-00002.jar:${modules}/org/wildfly/iiop-openjdk/main/wildfly-iiop-openjdk-7.1.5.GA-redhat-00002.jar
